...
def main(argv=None):
  ...
  framework = getattr(config, 'framework', 'jax')
  Agent = _select_agent(framework)
...
def make_env(config, index, **overrides):
  ...
  ctor = {
      ...
      'freerouting': 'embodied.envs.freerouting:Freerouting',
